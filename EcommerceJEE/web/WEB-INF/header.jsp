<%-- 
    Document   : header
    Created on : 4 sep. 2021, 23:12:01
    Author     : Eduardo
--%>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="Inicio"><img src="images/home/logo.png" alt="" /></a>
						</div>

						<div class="btn-group pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default dropdown-toggle usa" data-toggle="dropdown">
									${sessionScope.nomMoneda} (${sessionScope.moneda})
								...
								<ul class="dropdown-menu">
									...
									<li><a href="CambiarMoneda?moneda=USD">Dolár(USA) (USD)</a></li>
